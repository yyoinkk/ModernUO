namespace Server.Misc
{
    public static class RaceDefinitions
    {
        public static void Configure()
        {
            ...
            RegisterRace(new Drow(3, 3));
            RegisterRace(new Orc(4, 4));
            RegisterRace(new Dwarf(5, 5));
        }
        ...
        private class Elf : Race
        {
            ...
            {
                0x2B2, 0x2B7, 0x253, 0x24E, 0x1EA, 0x1EF
            };
        ...
        private class Drow : Race
        {
            ...
            public Drow(int raceID, int raceIndex)
                : base(raceID, raceIndex, "Drow", "Drows", 400, 401, 402, 403, Expansion.None)
            {
            }
        ...
        private class Dwarf : Race
        {
            private static readonly int[] m_SkinHues =
            {
                0x6B8, 0x6B9, 0x6BA, 0x6BB, 0x6BC, 0x6BD, 0x6BE
            };
            ...
            public Dwarf(int raceID, int raceIndex)
                : base(raceID, raceIndex, "Dwarf", "Dwarves", 400, 401, 402, 403, Expansion.None)
            {
            }
